...
window.processUrl = async () => {
    ...
    try {
        ...
        if (apiConfig && apiConfig.key && apiConfig.key !== "ISI_APIKEY_DISINI") {
            ...
            // Adaptasi response sesuai format API masing-masing
            // Ini contoh generik, sesuaikan jika API return strukturnya beda
            result = {
        ...
        // Fallback Mockup jika API Error/Kosong (Agar user tetap lihat hasil)
        if (!result) {
